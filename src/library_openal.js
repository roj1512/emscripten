...
var LibraryOpenAL = {
...
#if OPENAL_DEBUG
      dbg(`Anavigator.getUserMedia() errored with: ${mediaStreamError}`);
#endif
    };
      ...
      while (true) {
        ...
        case 0x1992 /* ALC_HRTF_SOFT */:
          switch (val) {
            ...
            default:
#if OPENAL_DEBUG
              dbg(`AUnsupported ALC_HRTF_SOFT mode ${val}`);
#endif
              AL.alcErr = {{{ cDefs.ALC_INVALID_VALUE }}};
              return 0;
          }
  ...
  emscripten_alcGetStringiSOFT: function(deviceId, param, index) {
    ...
    default:
      if (index !== 0) {
#if OPENAL_DEBUG
        dbg(`AalcGetStringiSOFT() with param ${ptrToString(param)} not implemented yet`);
#endif
        AL.alcErr = {{{ cDefs.ALC_INVALID_ENUM }}};
        return 0;
      }
